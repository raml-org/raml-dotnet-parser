...
function(t,e,r){/*!
	 ...
	 * MIT Licensed
	 */
var n=r(/*! ../eql */27);t.exports=function(t,e){e.add("eql",function(t,e){this.params={operator:"to equal",expected:t,showDiff:!0,message:e},this.assert(n(t,this.obj))}),e.add("equal",function(t,e){this.params={operator:"to be",expected:t,showDiff:!0,message:e},this.assert(t===this.obj)}),e.alias("equal","exactly")}},/*!******************************************!*\
