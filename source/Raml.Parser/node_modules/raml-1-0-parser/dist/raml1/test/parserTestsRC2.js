...
describe('External type facets tests', function () {
    ...
    it("JSON External type facets test 2", function () {
        parserTests.testErrors(util.data("../data/rc2/jsonSchemaNegative1.raml"), ["specifying unknown facet:properties"]);
    });
    it("JSON External type facets test 3", function () {
        parserTests.testErrors(util.data("../data/rc2/jsonSchemaNegative2.raml"), ["specifying unknown facet:minLength"]);
    });
    ...
    it("XSD External type facets test 2", function () {
        parserTests.testErrors(util.data("../data/rc2/xsdSchemaNegative1.raml"), ["specifying unknown facet:properties"]);
    });
    it("XSD External type facets test 3", function () {
        parserTests.testErrors(util.data("../data/rc2/xsdSchemaNegative2.raml"), ["specifying unknown facet:minLength"]);
    });
