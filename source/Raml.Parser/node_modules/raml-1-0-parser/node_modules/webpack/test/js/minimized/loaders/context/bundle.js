...
function(t,e,r){it("should be able to use a context with a loader",function(){var t="abc",e="script.coffee";r(/*! ../_resources */1)("./"+e).should.be.eql("coffee test"),r(/*! raw!../_resources */3)("./"+t+".txt").should.be.eql("abc")})},/*!*************************************!*\
  !*** ./loaders/_resources ^\.\/.*$ ***!
  \*************************************/
function(t,e,r){function n(t){return r(o(t))}function o(t){return i[t]||function(){throw new Error("Cannot find module '"+t+"'.")}()}var i={"./abc.txt":2,"./included.jade":5,"./parent.jade":6,"./script.coffee":8,"./template.jade":7};n.id=1,n.keys=function(){return Object.keys(i)},n.resolve=o,t.exports=n},/*!************************************!*\
  !*** ./loaders/_resources/abc.txt ***!
  \************************************/
function(){},/*!*****************************************************************!*\
  !*** ./loaders/_resources (webpack)/~/raw-loader!^\.\/.*\.txt$ ***!
  \*****************************************************************/
function(t,e,r){function n(t){return r(o(t))}function o(t){return i[t]||function(){throw new Error("Cannot find module '"+t+"'.")}()}var i={"./abc.txt":4};n.id=3,n.keys=function(){return Object.keys(i)},n.resolve=o,t.exports=n},/*!***********************************************************!*\
